  ...
  <div id='bannerplace' class='row'>
    <div class='col-sm-12 banner'>
      <div data-bind="if: documentReady, visible: show" class='center-fly'>
        <h2><span class="font-roboto-light"> That the</span><span> Forgotten</span><span class="font-roboto-light"> Be</span><span> Found </span><button type="button" class="btn btn-primary font-roboto-light btn-main-coh">See the Work</button></span></h2>
      </div>
