...
var bottomPics = {
				   'about':'<div class="col-sm-4 space"><div class=' + '"bottomview"><a href="#" class="info"><img src="images/about3.jpg" class="img-responsive center"><span class="border-box center"><h4 class="bottom-title">News</h4>  <p>Read more about...</p><span></a></div></div>',
				   'projects':'<div class="col-sm-4 space"><div class=' + '"bottomview"><a href="#" class="info"><img src="images/project2.jpg" class="img-responsive center"><span class="border-box center"><h4 class="bottom-title">News</h4>  <p>Read more about...</p><span></a></div></div>',
				   'news':'<div class="col-sm-4 space"><div class=' + '"bottomview"><a href="#" class="info"><img src="images/news2.jpg" class="img-responsive center"><span class="border-box center"><h4 class="bottom-title">News</h4>  <p>Read more about...</p><span></a></div></div>'
};
